...
class MLSettingsService {
  MLSettingsController _mlSettingsController = Get.find<MLSettingsController>();
  ...
  Future<void> getMLSettings() async {
    try {
      ...
      print("Error getting ML Settings: $e");
      _mlSettingsController.setLoading(false);
      CustomSnackbar.show("Error", "Failed to load ML Settings", isSuccess: false);
    }
  }
  ...
  Future<void> createMLSettings(String baseUrl) async {
    try {
      ...
      await sysConfigRef.doc('MemoizationURL').set({
        "URL": baseUrl,
        "updatedAt": DateTime.now(),
      }, SetOptions(merge: true)); // merge: true se existing data preserve rahega
      
      _mlSettingsController.setMLSettings(mlSettings);
      _mlSettingsController.setLoading(false);
      
      print("=========================================");
      print("ML SETTINGS CREATED SUCCESSFULLY");
      print("=========================================");
      print("Firebase Path: /SystemConfiguration/MemoizationURL");
      print("Field: URL");
      print("Value: ${mlSettings.baseUrl}");
      print("=========================================");
      
      CustomSnackbar.show("Success", "ML Settings saved successfully!\nPath: /SystemConfiguration/MemoizationURL");
    } catch (e) {
      print("Error creating ML Settings: $e");
      _mlSettingsController.setLoading(false);
      CustomSnackbar.show("Error", "Failed to save ML Settings", isSuccess: false);
    }
  }

  Future<void> updateMLSettings(MLSettingsModel mlSettings, String baseUrl) async {
    try {
      _mlSettingsController.setLoading(true);
      ...
      print("=========================================");
      print("ML SETTINGS UPDATED SUCCESSFULLY");
      print("=========================================");
      print("Firebase Path: /SystemConfiguration/MemoizationURL");
      print("Field: URL");
      print("Value: ${mlSettings.baseUrl}");
      print("Updated At: ${mlSettings.updatedAt}");
      print("=========================================");
      
      CustomSnackbar.show("Success", "ML Settings updated successfully!\nPath: /SystemConfiguration/MemoizationURL");
    } catch (e) {
      print("Error updating ML Settings: $e");
      _mlSettingsController.setLoading(false);
      CustomSnackbar.show("Error", "Failed to update ML Settings", isSuccess: false);
    }
  }
  ...
  Future<void> deleteMLSettings(String id) async {
    try {
      ...
      print("=========================================");
      print("ML SETTINGS DELETED SUCCESSFULLY");
      print("=========================================");
      print("Deleted Path: /SystemConfiguration/MemoizationURL");
      print("=========================================");
      
      CustomSnackbar.show("Success", "ML Settings deleted successfully");
    } catch (e) {
      print("Error deleting ML Settings: $e");
      _mlSettingsController.setLoading(false);
      CustomSnackbar.show("Error", "Failed to delete ML Settings", isSuccess: false);
    }
  }
}
