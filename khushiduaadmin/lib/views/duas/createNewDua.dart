                                        ...
                                        if ((isLittleKids &&
                                          ...
                                          DuaModel duaModel = DuaModel(
                                              ...
                                              arabic: arabicTextEditingController
                                                  .text,
                                              bengali: bengaliTextEditingController
                                                  .text,
                                              transliteration:
                                                  transliterationTextEditingController
                                                      .text,
                                              english: englishTextEditingController
                                                  .text,
                                              french: frenchTextEditingController
                                                  .text,
                                              german: germanTextEditingController
                                                  .text,
                                              gujrati: gujratiTextEditingController
                                                  .text,
                                              ...
                                              mandrain:
                                                  mandrainTextEditingController
                                                      .text,
                                              marathi: marathiTextEditingController
                                                  .text,
                                              portugese:
                                                  portugeseTextEditingController
                                                      .text,
                                              punjabi: punjabiTextEditingController
                                                  .text,
                                              russian:
                                                  russianTextEditingController
                                                      .text,
                                              sindhi: sindhiTextEditingController
                                                  .text,
                                              spanish:
                                                  spanishTextEditingController
                                                      .text,
                                              ...
                                              telgu: telguTextEditingController
                                                  .text,
                                              turkish: turkishTextEditingController
                                                  .text,
                                              updatedAt: DateTime.now(),
                                              urdu: urduTextEditingController
                                                  .text,
                                              order: duaController.allDuas.length +
                                                  1,
                                              grownUps: isGrownUps,
                                              ...
                                              littleKidsAudio: '',
                                              olderKidsAudio: '',
                                              benefits: benefitsTextAreaController.text.trim().isEmpty
                                                  ? null
