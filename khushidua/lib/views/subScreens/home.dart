                              ...
                              builder: (userController) {
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color:
                                          themeController.selectedAgeGroup == 0
                                          ? rpink
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    ...
                                    child: LinearProgressIndicator(
                                      value: 0.35,
                                      minHeight: 12.0,
                                      backgroundColor: rpurple.withOpacity(
                                        0.5,
                                      ), // Unfilled color with 50% opacity
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              height: 40,
                              decoration: BoxDecoration(
                                color: themeController.selectedAgeGroup == 1
                                    ? rblue
                                    : rwhite,
                                borderRadius: BorderRadius.circular(30),
                                border: Border.all(
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              height: 40,
                              decoration: BoxDecoration(
                                color: themeController.selectedAgeGroup == 2
                                    ? rgreen
                                    : rwhite,
                                borderRadius: BorderRadius.circular(30),
                                border: Border.all(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: rtext,
                                  fontWeight:
                                      themeController.selectedAgeGroup == 2
                                      ? FontWeight.bold
                                      : FontWeight.normal,
                                ),
                              ),
                        ...
                        child: GetBuilder<ThemeController>(
                          builder: (themeController) {
                            List<CategoryModel> filteredCategories =
                                categoryController.allCategories.where((
                                  category,
                                ) {
                                  if (themeController.selectedAgeGroup == 0) {
                                    return category.littleKids;
                                  } else if (themeController.selectedAgeGroup ==
                                      1) {
                            ...
                            if (themeController.selectedAgeGroup == 0) {
                              filteredCategories.removeWhere((category) {
                                final categoryName = category.english
                                    .toLowerCase();
